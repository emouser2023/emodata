...
csv_file = '/media/sdb_access/1_emotionCLIP/MELD_dataset/train_sent_emo.csv'
input_json_path ='/media/sdb_access/1_emotionCLIP/MELD_dataset/human+face_acm/train_bounding_boxes.json'
base_jason_path = '/media/sdb_access/1_emotionCLIP/MELD_dataset/json/train'
...
for row in tqdm(utterance_data):
    ...
    video_path = "/videos/train_splits/"+video_name
    # audio_path = "/audio/train_splits/"+audio_name
