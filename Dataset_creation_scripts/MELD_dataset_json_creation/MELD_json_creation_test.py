...
csv_file = '/media/sdb_access/1_emotionCLIP/MELD_dataset/test_sent_emo.csv'
input_json_path ='/media/sdb_access/1_emotionCLIP/MELD_dataset/human+face_acm/test_bounding_boxes.json'
base_jason_path = '/media/sdb_access/1_emotionCLIP/MELD_dataset/json/test'
...
for row in tqdm(utterance_data):
    ...
    video_path = "/videos/test_splits/"+video_name
    # audio_path = "/audio/test_splits/"+audio_name
