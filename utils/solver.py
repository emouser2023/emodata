...
def _optimizer(config, model,model_audio,fusion_model):
    if config.solver.optim == 'adam':
        optimizer = optim.Adam([{'params': model.parameters()},{'params': model_audio.parameters()},
        ...
        optimizer = optim.SGD([{'params': model.parameters()},{'params': model_audio.parameters()},{'params': fusion_model.parameters(), 'lr': config.solver.lr * config.solver.f_ratio}],
                              config.solver.lr,
        ...
        optimizer = optim.AdamW([{'params': text_params},
                                 {'params': model.visual.parameters(), 'lr': config.solver.lr * config.solver.ratio},{'params': model_audio.parameters()},
                                 {'params': fusion_model.parameters(), 'lr': config.solver.lr * config.solver.f_ratio}],
